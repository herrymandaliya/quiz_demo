<!DOCTYPE html>
<html lang="zxx">
   <!-- Mirrored from demo.epic-webdesign.com/tf-essentials/v1/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 09:40:05 GMT -->
   <head>
      <meta charset="utf-8">
         ...
         <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="container">
               ...
               <nav class="navbar navbar-expand-lg">
                  <!--begin logo -->
                  <a class="navbar-brand" href="#">Essentials</a>
                  <!--end logo -->
                  ...
                  <div class="navbar-collapse collapse" id="navbarCollapse" style="">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="discover-link"><a href="{{ url('register') }}  " class="external discover-btn">Get Started</a></li>
                     </ul>
                     <!--end navbar-nav -->
                  </div>
                  <!--end navbar-collapse -->
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-6 padding-top-80">
                  <h1>Welcome To Essentials, The&nbsp;Wold's Most Powerful SaaS Solution</h1>
                  <p>Essentials is designed with your customers in mind, so you can track and analyze all your data in one central location. There are no limits to how you can look at your data.</p>
                  <a href="#" class="btn-blue scrool">Start Your Free Trial</a>
               </div>
               <!--end col-md-6-->
               <!--begin col-md-6-->
               <div class="col-md-6">
                  <img src="front/images/website-development.jpg" class="hero-image width-100" alt="pic">
               </div>
               <!--end col-md-6-->
            </div>
            <!--end row -->
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="main-services">
                     <img src="front/images/main-service1.png" class="width-100" alt="pic">
                     <h3>Designers</h3>
               ...
               <div class="col-md-4">
                  <div class="main-services">
                     <img src="front/images/main-service2.png" class="width-100" alt="pic">
                     <h3>Marketers</h3>
                     <p>Curabitur quam etsum lacus netsum nulat iaculis ets vitae etsum nisle varius sed aliquam ets vitae netsum.</p>
               ...
               <div class="col-md-4">
                  <div class="main-services">
                     <img src="front/images/main-service3.png" class="width-100" alt="pic">
                     <h3>Agencies</h3>
                     <p>Curabitur quam etsum lacus netsum nulat iaculis ets vitae etsum nisle varius sed aliquam ets vitae netsum.</p>
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-6 wow slideInRight" data-wow-delay="0.25s" style="visibility: visible; animation-delay: 0.25s; animation-name: slideInRight;">
                  <img src="front/images/img10.png" class="width-100 box-shadow" alt="pic">
               </div>
               <!--end col-md-6-->
            </div>
            <!--end row -->
               ...
               <div class="col-md-6">
                  ...
                  <div class="video-popup-wrapper">
                     ...
                     <div class="popup-gallery">
                        <img src="front/images/img2.jpg" class="width-100 video-popup-image" alt="pic">
      ...
      <section class="section-white no-padding-bottom section-top-border">
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <!--begin col-md-6-->
               <div class="col-md-6">
                  <img src="front/images/testimonials-woman.jpg" class="width-100" alt="pic">
               </div>
               <!--end col-md-6-->
            </div>
            <!--end row -->
            ...
            <div class="row">
               ...
               <div class="col-md-12 text-center">
                  ...
                  <ul class="partners-mentions">
                     <li><img src="front/images/award4a.png" alt="CSS Awards"></li>
                     <li><img src="front/images/award1a.png" alt="Awwwards"></li>
                     <li><img src="front/images/award5.png" alt="CSS Winner"></li>
                     <li><img src="front/images/award3a.png" alt="CSS Design Awards"></li>
                  </ul>
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-6 margin-top-10">
                  <img src="front/images/img4.jpg" class="width-100 box-shadow" alt="picture">
               </div>
               <!--end col-sm-6-->
               <!--begin col-md-6-->
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-sm-12 col-md-4">
                  <div class="team-item">
                     <img src="front/images/team1.jpg" class="team-img" alt="pic">
               ...
               <div class="col-sm-12 col-md-4">
                  <div class="team-item">
                     <img src="front/images/team4.jpg" class="team-img" alt="pic">
               ...
               <div class="col-sm-12 col-md-4">
                  <div class="team-item">
                     <img src="front/images/team3.jpg" class="team-img" alt="pic">
                  ...
                  <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
                     ...
                     <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                           <div class="row">
                              <div class="col-sm-3">
                                 <img src="front/images/showcase1.jpg" alt="showcase" class="gallery-show">
                              </div>
                              <div class="col-sm-3">
                                 <img src="front/images/showcase2.jpg" alt="showcase" class="gallery-show">
                              </div>
                              <div class="col-sm-3">
                                 <img src="front/images/showcase3.jpg" alt="showcase" class="gallery-show">
                              </div>
                              <div class="col-sm-3">
                                 <img src="front/images/showcase4.jpg" alt="showcase" class="gallery-show">
                              </div>
                           </div>
                        </div>
                        <!--end carousel-item-->
                        ...
                        <div class="carousel-item">
                           <div class="row">
                              <div class="col-sm-3">
                                 <img src="front/images/showcase5.jpg" alt="showcase" class="gallery-show">
                              </div>
                              <div class="col-sm-3">
                                 <img src="front/images/showcase6.jpg" alt="showcase" class="gallery-show">
                              </div>
                              <div class="col-sm-3">
                                 <img src="front/images/showcase7.jpg" alt="showcase" class="gallery-show">
                              </div>
                              <div class="col-sm-3">
                                 <img src="front/images/showcase8.jpg" alt="showcase" class="gallery-show">
                              </div>
                           </div>
                        </div>
                        <!--end carousel-item-->
                     ...
                     <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                           ...
                           <div class="testim-inner">
                              <img src="front/images/testimonials1.jpg" alt="testimonials" class="testim-img">
                        ...
                        <div class="carousel-item">
                           <!--begin testim-inner -->
                           <div class="testim-inner">
                              <img src="front/images/testimonials2.jpg" alt="testimonials" class="testim-img">
                              <p>The attention of a traveller, should be particularly turned to the various works of nature, to mark the distinctions of the climates he may explore, and to offer such useful observations on the different productions as may occur.</p>
                        ...
                        <div class="carousel-item">
                           <!--begin testim-inner -->
                           <div class="testim-inner">
                              <img src="front/images/testimonials3.jpg" alt="testimonials" class="testim-img">
                              <p>The attention of a traveller, should be particularly turned to the various works of nature, to mark the distinctions of the climates he may explore, and to offer such useful observations on the different productions as may occur.</p>
      ...
      <section class="section-white section-bottom-border">
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <!--begin col-md-6-->
               <div class="col-md-6">
                  <img src="front/images/img0.png" class="hero-image width-100 box-shadow" alt="pic">
               </div>
               <!--end col-sm-6-->
            </div>
            <!--end row-->
               ...
               <div class="col-md-4">
                  ...
                  <div class="blog-item">
                     ...
                     <div class="popup-wrapper">
                        <div class="popup-gallery">
                           <a href="#">
                           <img src="front/images/blog1.jpg" class="width-100" alt="pic">
               ...
               <div class="col-md-4">
                  ...
                  <div class="blog-item">
                     ...
                     <div class="popup-wrapper">
                        <div class="popup-gallery">
                           <a href="#">
                           <img src="front/images/blog2.jpg" class="width-100" alt="pic">
                           <span class="eye-wrapper2"><i class="fa fa-link eye-icon"></i></span>
                           </a>
                        </div>
                     </div>
               ...
               <div class="col-md-4">
                  ...
                  <div class="blog-item">
                     ...
                     <div class="popup-wrapper">
                        <div class="popup-gallery">
                           <a href="#">
                           <img src="front/images/blog3.jpg" class="width-100" alt="pic">
                           <span class="eye-wrapper2"><i class="fa fa-link eye-icon"></i></span>
                           </a>
                        </div>
                     </div>
   ...
   <!-- Mirrored from demo.epic-webdesign.com/tf-essentials/v1/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 09:40:17 GMT -->
</html>
