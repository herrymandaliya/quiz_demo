...
function loadData(page, search) {
    showLoader();
    ajaxFetch(baseurl() + '/categories/load', { page: page, search: search }, formResponse);
}
...
function deleteEntity(category_id) {
	showModal();
	confirmDialoue("Delete", 'Are you sure you want to delete this category?', function(e){
		if (e) {
			ajaxUpdate(baseurl() + '/categories/destroy', { category_id: category_id }, function(responseText, statusText) {
				hideLoader();
				if(statusText == 'success') {
