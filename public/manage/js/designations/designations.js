...
function loadData(page, search) {
    showLoader();
    ajaxFetch(baseurl() + '/designations/load', { page: page, search: search }, formResponse);
}
...
function deleteEntity(designation_id) {
	showModal();
	confirmDialoue("Delete", 'Are you sure you want to delete this designation?', function(e){
		if (e) {
			ajaxUpdate(baseurl() + '/designations/destroy', { designation_id: designation_id }, function(responseText, statusText) {
				hideLoader();
				if(statusText == 'success') {
